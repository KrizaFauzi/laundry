          ...
          <div class="card-body">
            ...
            <div class="row mb-2">
                <div class="form-group col-4">
                    ...
                    <select class="form-select" id="id_outlet" aria-label="Default select example" name="id_outlet">
                        ...
                        <option value="{{ $outlet->id }}" {{ Auth::user()->id_outlet == $outlet->id ? 'selected' : '' }}>{{ $outlet->nama }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group col-4">
            ...
            <div class="row mb-4">
                ...
                <div class="form-group col-3">
                    ...
                    <input type="numeric" name="diskon" id="diskon" class="form-control">
                </div>
                <div class="form-group col-3">
                    <label for="pajak">Pajak</label>
                    <input type="numeric" name="pajak" id="pajak" class="form-control">
                </div>
                <div class="form-group col-3">
                    <label for="biaya_tambahan">Biaya Tambahan</label>
                    <input type="numeric" name="biaya_tambahan" id="biaya_tambahan" class="form-control">
                </div>
            </div>
            <div class="row mb-4">
